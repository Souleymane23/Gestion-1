                                ...
                                <form role="form" action="{{route('ajout_employer')}}" method="post">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="matricule" value="{{(rand(2000,100000))}}" disabled>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="6"  name="motif" placeholder="Motif conge ..."></textarea>
                                                </div>
                                            </div>
                                        <div class="col-sm-6">
                                            <!-- textarea -->
